# sweep launcher for split mnist vcl w/ active coreset selection
import yaml
import wandb
import torch
import numpy as np
...
def main():
    ...
    sweep_config_path=os.path.join(root_dir, "z_active_coreset/active_coreset_sp_mnist.yaml")
    output_dir = os.path.join(root_dir, "Active_Coreset_Split_MNIST")
    project_name = "vcl-active-coreset-split-mnist"
