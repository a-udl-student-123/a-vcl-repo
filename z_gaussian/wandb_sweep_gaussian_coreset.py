...
def main():
    ...
    sweep_config_path = os.path.join(os.path.dirname(__file__), "coreset_vcl_sweep.yaml")
    output_dir = os.path.join(root_dir, "Gauss_Permuted_MNIST/CoresetVCL") 
    project_name = "vcl-gaussian-permuted-mnist"
