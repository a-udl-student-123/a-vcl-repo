...
def main():
    ...
    sweep_config_path = os.path.join(root_dir, "z_sweep_configs/dgm_mnist/random_sweep.yaml")
    output_dir = os.path.join(root_dir, "DGM_MNIST/StandardVCL")
    project_name = "vcl-dgm-mnist"
