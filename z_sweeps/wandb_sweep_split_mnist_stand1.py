...
def main():
    ...
    sweep_config_path = os.path.join(root_dir, "z_sweep_configs/sp_mnist/standard_vcl1_sweep.yaml")
    output_dir = os.path.join(root_dir, "Split_MNIST/StandardVCL")
    ...
    wandb.agent(sweep_id, function=sweep_fn, count=54)
