...
def main():
    ...
    sweep_config_path = os.path.join(root_dir, "z_sweep_configs/sp_notmnist/coreset_vcl1_sweep.yaml")
    output_dir = os.path.join(root_dir, "Split_notMNIST/CoresetVCL")
    project_name = "vcl-split-notmnist-fixed"
